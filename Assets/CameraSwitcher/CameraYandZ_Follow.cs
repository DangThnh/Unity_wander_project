...
public class CameraYandZ_Follow : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        float targetZ = playerTarget.position.z + distanceOffset;
        ...
        transform.position = new Vector3(fixedX, smoothedY, smoothedZ);
        transform.position = new Vector3(fixedX, smoothedY, smoothedZ);
    }
}